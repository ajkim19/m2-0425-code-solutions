...
export default function App() {
  return (
    <>
      <Header header="React Image Bank" />
      <Image src="starry-sky.jpeg" />
      <Caption caption="A beautiful Image of Space" />
      <Description
        description="Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquam incidunt
      ...
      />
      <Button button="Click For Next Image" />
    </>
  );
}
